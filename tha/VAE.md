...
--- Summary for metal ---
Epoch:           179
L1:              0.007630 (Best: 0.007630)
MSE:             0.000526
PSNR:            38.88
SSIM:            0.9878
------------------------------
Scale Factor:    8.436274
Global Mean:     -0.001483
rEikonal (Recon):        0.012256  <- 越接近 0 模型越好
iEikonal (Interp):       0.012831  <- 绝对插值表现
Gap (i - r):     0.000575  <- 插值造成的性能退化量
------------------------------
